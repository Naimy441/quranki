    ...
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onDismiss}>
      <View style={styles.backdrop}>
        ...
        <View style={[styles.sheet, { backgroundColor: theme.card }]}>
          ...
          <Pressable onPress={() => { hapticSelection(); onJump(surah, ayah); }} style={({ pressed }) => [styles.go, { backgroundColor: theme.primary }, pressed && styles.pressed]}><ThemedText type="smallBold" style={styles.goText}>Go to {SURAH_INDEX[surah - 1]?.en} · Ayah {ayah}</ThemedText></Pressable>
        </View>
      </View>
    </Modal>
  );
